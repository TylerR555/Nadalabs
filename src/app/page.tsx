...
export default function Home() {
  ...
  if (isLoading) {
    ...
    <div className="min-h-screen bg-background">
      ...
      {/* Sticky Header Menu */}
      <header
        className={`sticky top-0 z-50 h-[80px] md:h-[106px] transition-all duration-300 ${
          isScrolled
        ...
        <div className="w-full h-full flex items-center justify-center px-4 md:px-6">
          <div className="w-full max-w-[1275px] h-full flex items-center justify-between">
            <div className="flex flex-col items-start">
              ...
              />
              <p className="text-black font-semibold mt-1 text-[9px] md:text-[11px]">
                Simplifying Managed Services
              </p>
            </div>
          ...
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-[1275px] h-full px-4 md:px-6">
            <div className="relative w-full h-full">
              ...
              <div className="absolute mt-10 left-0 top-0 w-full md:w-1/2 h-full flex flex-col justify-center md:justify-start md:items-end lg:items-start text-center md:text-left">
                ...
                <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 mb-8 md:mb-15 leading-relaxed text-sm md:text-lg lg:text-xl xl:text-[1.3rem] max-w-lg md:max-w-none">
                  Nadalabs takes the complexity out of business communications
          ...
          <div className="w-full flex items-center justify-center px-4 md:px-6">
            <div className="w-full max-w-[1275px] flex flex-col lg:flex-row lg:items-start lg:space-x-12 space-y-8 lg:space-y-0">
              ...
              <div className="w-full lg:w-2/5 flex flex-col">
                ...
                >
                  <span className="font-[family-name:var(--font-poppins)] font-normal text-sm md:text-base">
                    Who We Are
                  </span>
                </div>

                <h2 className="font-[family-name:var(--font-inter)] font-normal text-black leading-tight text-2xl md:text-4xl lg:text-5xl">
              ...
              <div className="w-full lg:w-3/5 flex flex-col space-y-4 md:space-y-6">
                <p className="font-[family-name:var(--font-poppins)] font-semibold text-gray-800 leading-relaxed text-sm md:text-base">
                  NadaLabs provides comprehensive, managed technology solutions
                  to help businesses streamline their network to make
                  communications, collaboration and connectivity simple and
                  cost-effective.
                </p>

                <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 leading-relaxed text-sm md:text-base">
                  Business networks are complex by nature. Add in multiple
                  locations and vendors, different ways of working, and evolving
                  technology needs and the infrastructure can quickly get out of
                  control. Without proper transparency, oversight, and
                  expertise, companies end up relying on insufficient legacy
                  systems, building out unsustainable networks, and overspending
                  on services they don&apos;t need.
                </p>

                <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 leading-relaxed mb-6 md:mb-8 text-sm md:text-base">
                  Nadalabs can help you right-fit your technology to meet your
                  current network needs and scale as you grow. Your network may
                  be complex, but it doesn&apos;t have to be unmanageable. Let
                  NadaLabs show you how.
                </p>
          ...
          <div className="w-full flex items-center justify-center">
            <div className="w-full max-w-[1275px] flex flex-col items-center">
              ...
              <div className="flex flex-col items-center mb-12 md:mb-16">
                ...
                <h2 className="font-[family-name:var(--font-inter)] font-normal text-black leading-tight text-center mb-4 md:mb-6 text-2xl md:text-4xl lg:text-5xl">
                  NadaLabs Solutions
                </h2>

                <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 text-center leading-relaxed max-w-4xl text-sm md:text-base">
                  Broad network expertise from a single provider. This is
                  <br className="hidden md:block" />
                  what an intelligent infrastructure looks like.
                </p>
              </div>
              ...
              <div className="w-full flex flex-col lg:flex-row lg:pl-15 lg:items-start lg:space-x-12 space-y-8 lg:space-y-0">
                ...
                <div className="w-full lg:w-1/2 flex flex-col">
                  <h3 className="font-[family-name:var(--font-inter)] font-normal text-black mb-4 md:mb-6 text-lg md:text-xl">
                  ...
                  <ul className="space-y-3 mb-4 md:mb-6">
                    <li className="flex items-center space-x-3">
                      ...
                      />
                      <span className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 text-lg md:text-xl lg:text-2xl">
                        UCaaS
                      </span>
                    </li>
                    <li className="flex items-center space-x-3">
                  ...
                  <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 leading-relaxed text-sm md:text-base">
                    NextGen Communications providing communication and
                ...
                <div className="w-full lg:w-1/2 flex flex-col">
                  ...
                  <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 leading-relaxed text-sm md:text-base">
                    Managed services offering connectivity, cloud computing,
            ...
            <div className="w-full max-w-[1275px] flex flex-col lg:flex-row lg:items-start lg:space-x-12 space-y-8 lg:space-y-0">
              ...
              <div className="w-full lg:w-1/2 flex flex-col justify-between h-full">
                ...
                <div>
                  ...
                  <h2 className="font-[family-name:var(--font-inter)] font-normal text-black leading-tight mb-4 md:mb-6 text-2xl md:text-4xl lg:text-5xl">
                    Need more information?
                  </h2>

                  <p className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 leading-relaxed mb-8 md:mb-12 text-sm md:text-base">
                    Tell us about your preferences and we&apos;ll
                    <br className="hidden md:block" /> guide you through the
                    process.
                  </p>
                </div>
                ...
                <div className="mt-auto">
                  <h3 className="font-[family-name:var(--font-inter)] font-normal text-black mb-4 md:mb-6 text-xl md:text-2xl">
                    Contact Us Now
                  </h3>
                  ...
                  <div className="space-y-3 md:space-y-4">
                    <div className="flex items-center space-x-3">
                      <Image
                        ...
                        className="flex-shrink-0"
                      />
                      <span className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 text-sm md:text-base">
                        <a className="underline" href="tel:+94117494164">+94 11 749 4164
                        </a>
                      </span>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      />
                      <div className="font-[family-name:var(--font-poppins)] font-normal text-gray-700 leading-relaxed text-sm md:text-base">
                        Nada Labs (PVT) LTD
                        <br />
                        Level 35, West Tower
                        <br />
              ...
              <div className="w-full lg:w-1/2">
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl border border-gray-200">
                  <form className="space-y-4 md:space-y-6">
                    ...
                    <div>
                      <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1 md:mb-2">
                        Need help? Let us know your preferences.
                      </label>
                      <textarea
                        rows={4}
        ...
        <footer className="bg-black text-white py-12 md:py-20">
          <div className="w-full flex items-center justify-center px-4 md:px-6">
            <div className="w-full max-w-[1275px] flex flex-col lg:flex-row lg:items-start lg:space-x-12 space-y-8 lg:space-y-0">
              {/* Column 1 */}
              <div className="w-full lg:w-1/2 flex flex-col">
                <h2 className="font-[family-name:var(--font-inter)] font-normal text-white leading-tight mb-6 md:mb-8 text-2xl md:text-3xl lg:text-4xl">
                  End-to-End UC Automation for Smarter Business Operations
                  <br className="hidden md:block" /> and Managed Services
                </h2>

                <h3 className="font-[family-name:var(--font-poppins)] font-semibold text-white mb-3 md:mb-4 text-lg md:text-xl">
                  Location
                </h3>

                <div className="font-[family-name:var(--font-poppins)] font-normal text-white leading-relaxed text-lg md:text-xl">
                  Nada Labs (PVT) LTD
                  <br />
                  Level 35, West Tower
                  <br />
              ...
              <div className="w-full lg:w-1/2 flex flex-col justify-between h-full">
                ...
                <div className="mt-auto">
                  <h3 className="font-[family-name:var(--font-poppins)] font-semibold text-white mb-4 md:mb-6 text-lg md:text-xl">
                    Follow Us
                  </h3>
